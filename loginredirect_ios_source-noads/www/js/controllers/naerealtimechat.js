...
App.config(function($stateProvider) {
    ...
    $stateProvider.state('naerealtimechat-view', {
        url: BASE_PATH+"/naerealtimechat/mobile_view/index/value_id/:value_id",
        controller: 'NaerealtimechatController',
        templateUrl: 'templates/naerealtimechat/l1/view.html'
    });


}).controller('NaerealtimechatController', function($ionicHistory, $cordovaOauth,AUTH_EVENTS, $ionicScrollDelegate, $location,$window, $scope, $state,$rootScope, $translate, $stateParams, Application, Customer, Dialog, HomepageLayout) {
