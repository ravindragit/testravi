var App = angular.module('starter', ['ionic', 'ion-gallery', 'ngCordova', 'ngIOS9UIWebViewPatch'])

.run(function($http, $ionicConfig, $ionicHistory, $ionicPlatform, $ionicPopup, $location, $rootScope, $state, $templateCache, $timeout, $translate, $window, Application, Connection, Customer, Dialog, FacebookConnect, Facebook, HomepageLayout, Push, Url, AUTH_EVENTS, PUSH_EVENTS) {
    ...
    $ionicPlatform.ready(function () {
        ...
        Dialog.is_webview = Application.is_webview;
    ...
    $rootScope.$on(PUSH_EVENTS.notificationReceived, function(event, args) {
        Dialog.alert($translate.instant("Notification"), args.message, $translate.instant("OK"));

        $rootScope.$broadcast(PUSH_EVENTS.unreadPushs, args.count);
    });
